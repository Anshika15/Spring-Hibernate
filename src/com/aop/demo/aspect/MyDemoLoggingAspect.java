...
public class MyDemoLoggingAspect {
	...
	@AfterThrowing(pointcut = "execution(* com.aop.demo.dao.AccountDAO.findAccounts(..))", throwing = "theExc")
	public void afterThrowingFindAccountAdvice(JoinPoint theJoinPoint, Throwable theExc) {
		...
		// log the exception
		System.out.println("\n---------->>> The Eception is : " + theExc);

	}

	@AfterReturning(pointcut = "execution(* com.aop.demo.dao.AccountDAO.findAccounts(..))", returning = "result")
